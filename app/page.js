            ...
            {[1, 2].map((_, idx) => (
              <div key={idx} style={{ display: 'flex', whiteSpace: 'nowrap' }}>
                <span style={{ marginRight: '50px' }}>
                  📢 <Link href="/admissions" style={{ textDecoration: 'none', color: '#fff' }}>Admissions for 1st Year (Session 2025-26) are now open. Apply before September 30th.</Link>
                </span>
                <span style={{ marginRight: '50px' }}>
                  🏆 <Link href="/notices" style={{ textDecoration: 'none', color: '#fff' }}>Result of 2nd Year FBISE Annual Exams announced. Congratulations to all passing students!</Link>
                </span>
                <span style={{ marginRight: '50px' }}>
                  📅 <Link href="/notices" style={{ textDecoration: 'none', color: '#fff' }}>Summer Vacation schedule updated by FGEI. Classes will resume on August 15th.</Link>
                </span>
              </div>
            ))}
          </div>
